...
Depending on your job role, finding a suitable repository to use could be simple. For example, if you are working at an institution which supports an **institutional repository** then your decision should be simple: use the local repository. However, there may be instances where you do not have access to an institutional repository (e.g. freelance researcher), or you would like to also reach a different audience. In this case you may prefer to use an alternative repository flavour, such as a subject-based repository.
...
### Section on manuscript types & distinguishing between them ###
